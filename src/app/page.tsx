	...
	return (
		<main>
			...
			<section className="mt-[-50px]">
				<LampComponent />
				<div
					className="flex flex-wrap items-center justify-center f
				lex-col gap-8 -mt-72"
				>
					<CardContainer className="inter-var">
						...
						>
							...
							text-sm max-w-sm mt-2 dark:text-neutral-300"
							>
								Get a glimpse of what Fuzzie is capable of.
							...
							<div className="flex justify-between items-center mt-8">
								...
								<CardItem
									translateZ="20"
									as="button"
									className="px-4 py-2 rounded-xl text-xs font-normal dark:bg-white dark:text-black"
								>
									Get Started Now
								</CardItem>
							</div>
					...
					<CardContainer className="inter-var">
						...
						>
							...
							text-sm max-w-sm mt-2 dark:text-neutral-300"
							>
								Unlock the full power of Fuzzie with our Professional plan.
								...
								<ul className="my-4 flex flex-col gap-2">
									...
									<li className="flex items-center gap-2">
										<CheckIcon /> 500 tasks per month
									</li>
									<li className="flex items-center gap-2">
										<CheckIcon /> Save workflows
									</li>
									<li className="flex items-center gap-2">
					...
					<CardContainer className="inter-var">
						...
						>
							...
							text-sm max-w-sm mt-2 dark:text-neutral-300"
							>
								Build and manage your Fuzzie workflows with your team.
								Everything in Hobby and Professional plus:
								<ul className="my-4 flex flex-col gap-2">
									<li className="flex items-center gap-2">
										<CheckIcon /> Unlimited users
									</li>
									<li className="flex items-center gap-2">
										<CheckIcon /> 10000 tasks per month
									</li>
									<li className="flex items-center gap-2">
										<CheckIcon /> Premier support
									</li>
									<li className="flex items-center gap-2">
										<CheckIcon /> Early access
									</li>
								</ul>
							</CardItem>
							<div className="flex justify-between items-center mt-8">
